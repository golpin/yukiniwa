        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-16 ">
            <div class="overflow-hidden bg-white rounded-lg shadow-sm">
                <div class="px-2 py-4 bg-indigo-100 border-b border-gray-200">
                    <h2 class="w-3/4 mx-auto text-xl text-center border-b-2 border-indigo-500 sm:w-1/3">スキー場登録フォーム</h2>
                    <form action="{{ route('admin.skiResortStore') }}" method="POST"　onsubmit="return checkSubmit()">
                        @csrf
